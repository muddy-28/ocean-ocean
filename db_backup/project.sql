...
INSERT INTO `comment` (`comment_id`, `comment`, `catagory`, `project_id`, `user_id`) VALUES
(1, 'pakistan pakistan pakistan ', 'pakistan ', 15, 11),
(2, 'nepal ', 'pakistan ', 15, 11),
(3, 'nepal ', 'pakistan ', 15, 11),
(4, 'nepal ', 'pakistan ', 15, 11),
(10, 'adnasndasd', 'pakistan', 15, 11),
(11, 'adnasndasd', 'pakistan', 15, 11),
(12, 'nepal', 'pakistan', 15, 11),
(13, 'okie', 'pakistan', 15, 11),
(14, 'okie', 'pakistan', 15, 11);
...
--
ALTER TABLE `comment`
  ADD PRIMARY KEY (`comment_id`), ADD KEY `comment_ibfk_1` (`project_id`), ADD KEY `comment_ibfk_2` (`user_id`);
